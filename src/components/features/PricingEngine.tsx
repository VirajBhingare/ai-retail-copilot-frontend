...
export const PricingEngine = () => {
  ...
  return (
    <div className="p-4 md:p-6 h-full flex flex-col bg-[#F3F0FF] dark:bg-[#1E1B24] overflow-hidden">
      {/* Header & Stats Cards */}
      <div className="mb-4 md:mb-6 shrink-0">
        <div className="mb-4">
          <h1 className="text-xl md:text-2xl font-bold text-[#4A3D63] dark:text-[#BCA3E0] flex items-center gap-2">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 md:gap-4">
          <div className="p-4 rounded-xl border border-[#E5E0F1] dark:border-[#3B3446] bg-white dark:bg-[#2A2533] shadow-sm flex items-center gap-4">
            <div className="p-3 rounded-full bg-[#EADAFF]/50 dark:bg-[#3B3446] text-[#8264C2] dark:text-[#BCA3E0] shrink-0">
              <Package size={24} />
            </div>
            <div>
              ...
              <p className="text-xl md:text-2xl font-bold text-gray-900 dark:text-[#E2DFE7]">
                {totalProducts}
              </p>
            </div>
          </div>
          ...
          <div className="p-4 rounded-xl border border-red-100 dark:border-red-900/30 bg-red-50/50 dark:bg-red-500/5 shadow-sm flex items-center gap-4">
            <div className="p-3 rounded-full bg-red-100 dark:bg-red-500/10 text-red-600 dark:text-red-400 shrink-0">
              <AlertCircle size={24} />
            </div>
            <div>
              <p className="text-xs md:text-sm text-red-600/80 dark:text-red-400/80 font-medium">
                Price Undercut Risk
              </p>
              <p className="text-xl md:text-2xl font-bold text-red-700 dark:text-red-400">
                {undercutCount}{" "}
                <span className="text-xs md:text-sm font-normal">items</span>
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Data Table */}
      <div className="flex-1 overflow-hidden rounded-xl border border-[#E5E0F1] dark:border-[#3B3446] bg-white dark:bg-[#2A2533] shadow-sm flex flex-col">
        {loading ? (
          ...
          <div className="flex-1 overflow-auto">
            <table className="w-full text-left text-sm text-gray-600 dark:text-gray-300 min-w-[700px]">
              <thead className="sticky top-0 bg-[#F8F7FA] dark:bg-[#15131A] text-xs uppercase text-gray-500 dark:text-gray-400 border-b border-[#E5E0F1] dark:border-[#3B3446] z-10 shadow-sm">
                <tr>
                  <th className="px-4 py-3 md:px-6 md:py-4 font-semibold whitespace-nowrap">
                    Product Name
                  </th>
                  <th className="px-4 py-3 md:px-6 md:py-4 font-semibold whitespace-nowrap">
                    Our Price
              ...
              <tbody className="divide-y divide-[#E5E0F1] dark:divide-[#3B3446]">
                {products.map((product) => {
                  ...
                  return (
                    ...
                    >
                      <td className="px-4 py-3 md:px-6 md:py-4 font-medium text-gray-900 dark:text-[#E2DFE7]">
                        {product.name}
                        <span className="block text-xs font-normal text-gray-400 mt-0.5">
                          {product.category}
                        </span>
                      </td>
                      <td className="px-4 py-3 md:px-6 md:py-4 font-semibold text-gray-900 dark:text-[#E2DFE7] whitespace-nowrap">
                        ₹{product.basePrice?.toFixed(2)}
                      </td>
                      <td className="px-4 py-3 md:px-6 md:py-4 text-gray-500 dark:text-gray-400 whitespace-nowrap">
                        {compName}
                      </td>
