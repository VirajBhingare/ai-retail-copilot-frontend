                ...
                {products.map((product) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3 md:px-6 md:py-4">
                      <span className="inline-flex items-center rounded-md bg-[#EADAFF]/50 dark:bg-[#3B3446] px-2 py-1 text-xs font-medium text-[#8264C2] dark:text-[#BCA3E0] ring-1 ring-inset ring-[#D5C6EB] dark:ring-[#4A3D63] whitespace-nowrap">
                        {product.category}
                      </span>
                    </td>
